...
import GlobalDB from 'Handles/DB/Global'
...
export default class Application {
  ...
  translate(path: string, serverid: string = '', tags: { [key: string]: string } = {}) {
    return this.translator.translate(path, serverid, tags)
  }
  ...
  initBot() {
    ...
    this.client.user.setActivity(this.config.status.replace('{prefix}', this.config.prefix), { url: 'https://callmegus.xyz', type: 'WATCHING' })
  }
